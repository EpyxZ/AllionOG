...
QString BitcoinUnits::name(int unit)
{
    switch(unit)
    {
    case BTC: return QString("ALLOG");
    case mBTC: return QString("mALLOG");
    case uBTC: return QString::fromUtf8("μALLOG");
...
QString BitcoinUnits::description(int unit)
{
    switch(unit)
    {
    case BTC: return QString(QObject::tr("AllionOGs"));
    case mBTC: return QString(QObject::tr("Milli-AllionOGs (1 / 1,000)"));
    case uBTC: return QString(QObject::tr("Micro-AllionOGs (1 / 1,000,000)"));
    default: return QString("???");
    }
}
