...
{
    QString link = "https://www.cryptopia.co.nz/Exchange/?market=ALLOG_BTC";
    QDesktopServices::openUrl(QUrl(link));
}

void OverviewPage::on_commandLinkButton_2_clicked()
{
    QString link = "https://yobit.io/en/trade/ALLOG/BTC/?bonus=Lgeye";
    QDesktopServices::openUrl(QUrl(link));
}

void OverviewPage::on_commandLinkButton_3_clicked()
{
    QString link = "https://www.coinexchange.io/market/ALLOG/BTC?r=844c4e9d";
    QDesktopServices::openUrl(QUrl(link));
...
{
    QString link = "https://novaexchange.com/market/BTC_ALLOG/";
    QDesktopServices::openUrl(QUrl(link));
}
